...
function highlightFeature(e) {
	...
	//chercher le query>SelectAll pour les target ayant le meme id que la feature survolée
	//console.log(e.target)

    //Je sais pas comment récuper avec le querySelectorAll parce que les paths n'ont pas d'id
    const sameID = document.querySelectorAll(`.leaflet-interactive`);
    console.log(sameID);
	...
	//tooltip : layer.bindTooltip(feature.properties.annee),
	//.legend 
...
function onEachFeature(feature, layer) {
    layer.on({
        //mouseover : layer.openPopup(feature.properties.annee),
